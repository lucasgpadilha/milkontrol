...
const navItems = [
  ...
  { href: "/modo-ordenha", label: "Modo Ordenha", icon: Zap, roles: ["PROPRIETARIO", "GERENTE", "OPERADOR"] },
  { href: "/lactacao", label: "Lactação", icon: FlaskConical, roles: ["PROPRIETARIO", "GERENTE", "OPERADOR"] },
  { href: "/tanque", label: "Tanque de Leite", icon: Cylinder, roles: ["PROPRIETARIO", "GERENTE"] },
  { href: "/qualidade-leite", label: "Qualidade", icon: FlaskRound, roles: ["PROPRIETARIO", "GERENTE"] },
  { type: "separator" as const },
  { href: "/agenda", label: "Agenda", icon: CalendarClock, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO"] },
  { href: "/reproducao", label: "Reprodução", icon: Heart, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO"] },
  { href: "/partos", label: "Partos", icon: Baby, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO", "OPERADOR"] },
  { href: "/semen", label: "Sêmen", icon: Snowflake, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO"] },
  { href: "/estoque", label: "Estoque", icon: Package, roles: ["PROPRIETARIO", "GERENTE"] },
  { type: "separator" as const },
  { href: "/sanitario", label: "Sanitário", icon: Syringe, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO"] },
  { href: "/mastite", label: "Mastite", icon: AlertCircle, roles: ["PROPRIETARIO", "GERENTE", "VETERINARIO", "OPERADOR"] },
  ...
  { href: "/financeiro", label: "Financeiro", icon: DollarSign, roles: ["PROPRIETARIO", "GERENTE"] },
